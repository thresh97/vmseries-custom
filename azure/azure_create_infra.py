...
def main() -> None:
    ...
    parser_create.add_argument("--vm-size", default="Standard_D3_v2", help="Azure VM size (default: Standard_D3_v2).")
    ...
    parser_cci.add_argument("--vm-size", default="Standard_D3_v2", help="Azure VM size (default: Standard_D3_v2).")
